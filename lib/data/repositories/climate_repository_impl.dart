...
class ClimateRepositoryImpl implements ClimateRepository {
  ...
  Future<void> connect(String ip, int port, {String? noisePsk}) async {
    if (_service.host != ip) {
      throw ArgumentError(
        'Repository service host (${_service.host}) does not match requested IP ($ip)',
      );
    }
  ...
  ClimateMode _mapProtoMode(pb.ClimateMode mode) {
    switch (mode) {
      case pb.ClimateMode.CLIMATE_MODE_OFF:
        return ClimateMode.off;
      case pb.ClimateMode.CLIMATE_MODE_COOL:
        return ClimateMode.cool;
      case pb.ClimateMode.CLIMATE_MODE_HEAT:
        return ClimateMode.heat;
      case pb.ClimateMode.CLIMATE_MODE_HEAT_COOL:
        return ClimateMode.auto;
      case pb.ClimateMode.CLIMATE_MODE_FAN_ONLY:
        return ClimateMode.fanOnly;
      case pb.ClimateMode.CLIMATE_MODE_DRY:
  ...
  FanMode _mapProtoFanMode(pb.ClimateFanMode mode) {
    switch (mode) {
      case pb.ClimateFanMode.CLIMATE_FAN_LOW:
        return FanMode.low;
      case pb.ClimateFanMode.CLIMATE_FAN_MEDIUM:
        return FanMode.medium;
      case pb.ClimateFanMode.CLIMATE_FAN_HIGH:
        return FanMode.high;
      case pb.ClimateFanMode.CLIMATE_FAN_AUTO:
        return FanMode.auto;
      default:
        return FanMode.auto;
    }
  ...
  ClimateAction _mapProtoAction(pb.ClimateAction action) {
    switch (action) {
      case pb.ClimateAction.CLIMATE_ACTION_OFF:
        return ClimateAction.off;
      case pb.ClimateAction.CLIMATE_ACTION_IDLE:
        return ClimateAction.idling;
      case pb.ClimateAction.CLIMATE_ACTION_COOLING:
        return ClimateAction.cooling;
      case pb.ClimateAction.CLIMATE_ACTION_HEATING:
        return ClimateAction.heating;
      case pb.ClimateAction.CLIMATE_ACTION_DRYING:
        return ClimateAction.drying;
      case pb.ClimateAction.CLIMATE_ACTION_FAN:
        return ClimateAction.fanning;
      default:
        return ClimateAction.off;
    }
  }
  ...
  pb.ClimateMode _mapDomainMode(ClimateMode mode) {
    switch (mode) {
      case ClimateMode.off:
        return pb.ClimateMode.CLIMATE_MODE_OFF;
      case ClimateMode.cool:
        return pb.ClimateMode.CLIMATE_MODE_COOL;
      case ClimateMode.heat:
        return pb.ClimateMode.CLIMATE_MODE_HEAT;
      case ClimateMode.auto:
        return pb.ClimateMode.CLIMATE_MODE_HEAT_COOL;
      case ClimateMode.fanOnly:
        return pb.ClimateMode.CLIMATE_MODE_FAN_ONLY;
      case ClimateMode.dry:
        return pb.ClimateMode.CLIMATE_MODE_DRY;
    }
  }
}
